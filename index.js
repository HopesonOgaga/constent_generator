...
let shw_riddle = document.getElementsByClassName("wisdom");
let wisdom_shw = document.getElementsByClassName("riddles");
function showMeme() {
  // Value is a string representing image URL
  let shw_memes = document.querySelector(".shw_memes");
  const randomMemeUrl = getRandomData("memes");
  const new_img = document.createElement("img");
  new_img.setAttribute("src", randomMemeUrl);
  const is_img = new_img.querySelector("img");

  let stop_img = document.querySelector("img");
  if (stop_img) {
    shw_memes.innerHTML = "";
  }
  shw_memes.appendChild(new_img);
}
...
function showJoke() {
  ...
  let tell_joke = document.querySelector(".tell_joke");
  const randomJokeText = getRandomData("jokes");
  let new_p = document.createElement("p");
  new_p.textContent = randomJokeText;

  let joke_stop = document.querySelector("p");
  if (joke_stop) {
    tell_joke.innerHTML = "";
  }
  tell_joke.appendChild(new_p);
...
function showQuote() {
  ...
  let show_quote = document.querySelector(".wisdom");
  // console.log(show_quote)
  ...
  let clr_quote = document.querySelector("p");
  if (clr_quote) {
    show_quote.innerHTML = "";
  }
  show_quote.appendChild(quote);
  show_quote.appendChild(author);
...
function showRiddle() {
  ...
  new_question.textContent = question;

  const reveal_ans = document.querySelector("p");
  reveal_ans.textContent = answer;
  reveal_ans.setAttribute("id", "riddle_answer");
  reveal_ans.hidden = true;

  let shw_riddle = document.querySelector(".riddles");

  let clr_riddle = document.querySelector("p");
  if (clr_riddle) {
    shw_riddle.innerHTML = "";
  }

  shw_riddle.appendChild(new_question);
  shw_riddle.appendChild(reveal_ans);
}
...
function revealAnswers() {
  const riddle_container = document.querySelector('.riddles')
 ...
 answer.hidden= false
  ...
  alert('the answer is alreaddy revealed')
}else {
  alert ('there is no riddle to reveled the answer')
}
}
/**
